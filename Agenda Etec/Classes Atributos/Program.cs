             ...
             if (ApplicationDeployment.IsNetworkDeployed)
             {
                 ...
                 else
                 {
                     ...
                     else
                     {
                         ...
                         icon.BalloonTipText = "Agenda Etec já está em uso, procure na barra de ferramentas em MOSTRAR ÍCONES OCULTOS e clique duas vezes sobre o ícone";
                         icon.BalloonTipTitle = "Aviso";
                         icon.Icon = System.Drawing.Icon.ExtractAssociatedIcon(Application.ExecutablePath);
                         icon.Visible = true;
                         icon.ShowBalloonTip(100000);
                         icon.Dispose();
                     }
                 }
             }
