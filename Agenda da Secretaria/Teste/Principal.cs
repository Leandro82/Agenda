...
namespace Teste
{
    public partial class Principal : Form
    {
        ...
        private void copias_Tick(object sender, EventArgs e)
        {
            ...
            int cont = co.PrincipalImp().Rows.Count;
            if (cont >= 1)
            {
                notifyIcon1.Visible = true;
                notifyIcon1.ShowBalloonTip(100000, "Atenção", "Existe(m) cópia(s) para imprimir no Sistema Requisição", ToolTipIcon.Info);
            }
        }
