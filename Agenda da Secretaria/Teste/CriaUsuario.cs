...
namespace Teste
{
    class CriaUsuario
    {
        ...
        public DataTable Usuario()
        {
            ...
            MySqlConnection con = new MySqlConnection("Persist Security Info=false;SERVER=10.66.121.42;DATABASE=agenda;UID=secac;pwd=secac");
        ...
        {
            us.Acesso = acesso;
            string caminho = "Persist Security Info=false;SERVER=10.66.121.42;DATABASE=agenda;UID=secac;pwd=secac";
