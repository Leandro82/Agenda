...
namespace Teste
{
    public partial class frmPesqEventos : Form
    {
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            string data = dataGridView1[1, dataGridView1.CurrentCellAddress.Y].Value.ToString();
            string dtCad = dataGridView1[2, dataGridView1.CurrentCellAddress.Y].Value.ToString();
