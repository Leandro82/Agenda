...
namespace Teste {
    ...
    public partial class agendaDataSet : global::System.Data.DataSet {
        ...
        public partial class agendaDataTable : global::System.Data.TypedTableBase<agendaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public agendaRow AddagendaRow(string nome, System.DateTime data, string horario, string evento) {
            ...
            private void InitClass() {
                ...
                this.columnevento.MaxLength = 300;
            }
...
namespace Teste.agendaDataSetTableAdapters {
    ...
    public partial class agendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `agenda` WHERE ((`cod` = @p1) AND (`nome` = @p2) AND (`data` = @p3) A" +
                "ND (`horario` = @p4) AND (`evento` = @p5))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `agenda` (`nome`, `data`, `horario`, `evento`) VALUES (@p1, @p2, @p3," +
                " @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `agenda` SET `nome` = @p1, `data` = @p2, `horario` = @p3, `evento` = @p4 W" +
                "HERE ((`cod` = @p5) AND (`nome` = @p6) AND (`data` = @p7) AND (`horario` = @p8) " +
                "AND (`evento` = @p9))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `cod`, `nome`, `data`, `horario`, `evento` FROM `agenda`";
